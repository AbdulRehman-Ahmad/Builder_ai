            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full pl-2 border-b border-zinc-200 focus:outline-none focus:border-zinc-950 text-sm text-zinc-900 bg-transparent placeholder-zinc-300 pr-8"
                  placeholder="••••••••"
                />
