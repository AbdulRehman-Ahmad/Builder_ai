...
import { ArrowLeftIcon, MessageSquareIcon, FolderTreeIcon } from 'lucide-react'
      ...
      <div className="w-[320px] shrink-0 flex flex-col border-r border-zinc-200 bg-white">
        ...
        <div className="flex border-b border-zinc-100">
          <button onClick={() => setLeftTab("chat")}
            ...
            font-medium cursor-pointer ${leftTab === "chat" ? "text-zinc-900 border-b-2 border-zinc-900" 
          ...
          <button onClick={() => setLeftTab("files")}
            ...
            ${ leftTab === "files" ? "text-zinc-900 border-b-2 border-zinc-900" : "text-zinc-400 hover:text-zinc-700" }`}>
