    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between px-3 pb-3 gap-2">
          <label
            htmlFor="file"
            className="flex items-center justify-center p-1.5 border border-white/20 rounded-md text-white/80 hover:text-white hover:border-white/30 cursor-pointer"
          >
